            ...
            if interaction.user not in view.players:
                ...
                if view.game[interaction.user] is None:
                    ...
                    if None in view.game.values():
                        ...
                        ac = view.game[view.players[0]]
                        pc = view.game[view.players[1]]
                        ...
                        if val == 0:   
                            ...
                            await interaction.response.edit_message(content=f"{list(view.game.keys())[0]} Won by shosing {ac}", view=view)
                            return
                        elif val == -1:
                            await interaction.response.edit_message(content=f"{list(view.game.keys())[1]} Won by shosing {pc}", view=view)
                            return
